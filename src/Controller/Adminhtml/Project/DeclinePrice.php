...
class DeclinePrice extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            $projectApi->declinePrice($bridgeProject);
            $project->setData('status', Status::PRICE_DECLINED);
            $project->save();
            $this->messageManager->addSuccessMessage(__('The price of the project has successfully been declined.'));
